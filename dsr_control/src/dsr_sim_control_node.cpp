...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "dsr_sim_control_node", ros::init_options::NoSigintHandler);
    ...
    ///dsr_control::DRHWInterface_SIM arm(nh);
    DRHWInterface_SIM* pArm = NULL;
    pArm = new DRHWInterface_SIM(private_nh);
