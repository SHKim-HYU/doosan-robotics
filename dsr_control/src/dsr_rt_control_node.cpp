...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "dsr_rt_control_node", ros::init_options::NoSigintHandler);
    ...
    ///dsr_control::DRHWInterface_RT arm(nh);
    DRHWInterface_RT* pArm = NULL;
    pArm = new DRHWInterface_RT(private_nh);
