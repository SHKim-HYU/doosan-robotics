...
#include "dsr_control/dsr_sim_hw_interface.h"
...
namespace dsr_control{
    ...
    void DRHWInterface_SIM::OnTpInitializingCompletedCB()
    {
    ...
    void DRHWInterface_SIM::OnHommingCompletedCB()
    {
    ...
    void DRHWInterface_SIM::OnProgramStoppedCB(const PROGRAM_STOP_CAUSE iStopCause)
    {
        cout << "[callback OnProgramStoppedCB] Program Stop: " << (int)iStopCause << endl;
        g_stDrState.bDrlStopped = TRUE;
    }
    // M2.4 or lower
    void DRHWInterface_SIM::OnMonitoringCtrlIOCB (const LPMONITORING_CTRLIO pCtrlIO)
    {
    ...
    // M2.5 or higher
    void DRHWInterface_SIM::OnMonitoringCtrlIOExCB (const LPMONITORING_CTRLIO_EX pCtrlIO)
    {
        //ROS_INFO("DRHWInterface_SIM::OnMonitoringCtrlIOExCB");
    ...
    // M2.4 or lower
    void DRHWInterface_SIM::OnMonitoringDataCB(const LPMONITORING_DATA pData)
    {
        // This function is called every 100 msec
        // Only work within 50msec
        //ROS_INFO("DRHWInterface_SIM::OnMonitoringDataCB");
    ...
    // M2.5 or higher
    void DRHWInterface_SIM::OnMonitoringDataExCB(const LPMONITORING_DATA_EX pData)
    {
        // This function is called every 100 msec
        // Only work within 50msec
        //ROS_INFO("DRHWInterface_SIM::OnMonitoringDataExCB");
    ...
    void DRHWInterface_SIM::OnMonitoringModbusCB (const LPMONITORING_MODBUS pModbus)
    {
    ...
    void DRHWInterface_SIM::OnMonitoringStateCB(const ROBOT_STATE eState)
    {
        //This function is called when the state changes.
        //ROS_INFO("DRHWInterface_SIM::OnMonitoringStateCB");
        // Only work within 50msec
    ...
    void DRHWInterface_SIM::OnMonitoringAccessControlCB(const MONITORING_ACCESS_CONTROL eAccCtrl)
    {
        // Only work within 50msec
    ...
    void DRHWInterface_SIM::OnLogAlarm(LPLOG_ALARM pLogAlarm)
    {
        //This function is called when an error occurs.
        ros::NodeHandlePtr node=boost::make_shared<ros::NodeHandle>();
        ros::Publisher PubRobotError=node->advertise<dsr_sim_msgs::RobotError>("error",100);
        dsr_sim_msgs::RobotError msg;
    ...
    void DRHWInterface_SIM::OnTpPopupCB(LPMESSAGE_POPUP tPopup)
    {
        ROS_INFO("OnTpPopup");
    }

    void DRHWInterface_SIM::OnTpLogCB(const char* strLog)
    {
        ROS_INFO("OnTpLog");
        cout << strLog << endl;
    }

    void DRHWInterface_SIM::onTpProgressCB(LPMESSAGE_PROGRESS tProgress)
    {
        ROS_INFO("OnTpProgress");
    }

    void DRHWInterface_SIM::OnTpGetUserInputCB(LPMESSAGE_INPUT tInput)
    {
    ...
    
    void MsgScriber(const dsr_sim_msgs::RobotStop::ConstPtr& msg)
    {
    ...
    int DRHWInterface_SIM::MsgPublisher_RobotState()
    {
        dsr_sim_msgs::RobotState msg;
        dsr_sim_msgs::ModbusState modbus_state;
    ...
    /* 현재 미사용 : DRHWInterface_SIM::OnLogAlarm 에서 바로 퍼블리싱 함.
    int DRHWInterface_SIM::MsgPublisher_RobotError()
    {
        dsr_sim_msgs::RobotError msg;
    ...
    */
    ...
    void DRHWInterface_SIM::thread_subscribe(ros::NodeHandle nh)
    {
        //ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();
    ...
    void DRHWInterface_SIM::thread_publisher(DRHWInterface_SIM* pDRHWInterface_SIM, ros::NodeHandle nh, int nPubRate)
    {
        //ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();
        ros::Publisher PubRobotState = nh.advertise<dsr_sim_msgs::RobotState>("state",100);
        dsr_sim_msgs::RobotState msg;
        ...
        while (ros::ok())
        {
            ...
            if(pDRHWInterface_SIM) pDRHWInterface_SIM->MsgPublisher_RobotState();
            r.sleep();
        }
    }

    DRHWInterface_SIM::DRHWInterface_SIM(ros::NodeHandle& nh):private_nh_(nh)
    {
        /*
        ...
        */
        ...
        // Publisher msg
        m_PubRobotState = private_nh_.advertise<dsr_sim_msgs::RobotState>("state",100);
        m_PubRobotError = private_nh_.advertise<dsr_sim_msgs::RobotError>("error",100);
        ///m_PubJogMultiAxis = private_nh_.advertise<dsr_sim_msgs::JogMultiAxis>("jog_multi",100);
        ...
        m_sub_joint_trajectory = private_nh_.subscribe("dsr_joint_trajectory_controller/follow_joint_trajectory/goal", 10, &DRHWInterface_SIM::trajectoryCallback, this);
        // topic echo 명령으로 제어기에 전달
        m_sub_joint_position = private_nh_.subscribe("dsr_joint_position_controller/command", 1, &DRHWInterface_SIM::positionCallback, this);
        ...
        m_sub_jog_multi_axis = private_nh_.subscribe("jog_multi", 10, &DRHWInterface_SIM::jogCallback, this);
        m_sub_alter_motion_stream = private_nh_.subscribe("alter_motion_stream", 20, &DRHWInterface_SIM::alterCallback, this);
        m_sub_servoj_stream = private_nh_.subscribe("servoj_stream", 20, &DRHWInterface_SIM::servojCallback, this);
        m_sub_servol_stream = private_nh_.subscribe("servol_stream", 20, &DRHWInterface_SIM::servolCallback, this);
        m_sub_speedj_stream = private_nh_.subscribe("speedj_stream", 20, &DRHWInterface_SIM::speedjCallback, this);
        m_sub_speedl_stream = private_nh_.subscribe("speedl_stream", 20, &DRHWInterface_SIM::speedlCallback, this);

        m_sub_servoj_rt_stream = private_nh_.subscribe("servoj_rt_stream", 20, &DRHWInterface_SIM::servojRTCallback, this);
        m_sub_servol_rt_stream = private_nh_.subscribe("servol_rt_stream", 20, &DRHWInterface_SIM::servolRTCallback, this);
        m_sub_speedj_rt_stream = private_nh_.subscribe("speedj_rt_stream", 20, &DRHWInterface_SIM::speedjRTCallback, this);
        m_sub_speedl_rt_stream = private_nh_.subscribe("speedl_rt_stream", 20, &DRHWInterface_SIM::speedlRTCallback, this);
        m_sub_torque_rt_stream = private_nh_.subscribe("torque_rt_stream", 20, &DRHWInterface_SIM::torqueRTCallback, this);

        // system Operations
        m_nh_system[0] = private_nh_.advertiseService("system/set_robot_mode", &DRHWInterface_SIM::set_robot_mode_cb, this);
        m_nh_system[1] = private_nh_.advertiseService("system/get_robot_mode", &DRHWInterface_SIM::get_robot_mode_cb, this);
        m_nh_system[2] = private_nh_.advertiseService("system/set_robot_system", &DRHWInterface_SIM::set_robot_system_cb, this);
        m_nh_system[3] = private_nh_.advertiseService("system/get_robot_system", &DRHWInterface_SIM::get_robot_system_cb, this);
        m_nh_system[4] = private_nh_.advertiseService("system/set_robot_speed_mode", &DRHWInterface_SIM::set_robot_speed_mode_cb, this);
        m_nh_system[5] = private_nh_.advertiseService("system/get_robot_speed_mode", &DRHWInterface_SIM::get_robot_speed_mode_cb, this);
        m_nh_system[6] = private_nh_.advertiseService("system/get_current_pose", &DRHWInterface_SIM::get_current_pose_cb, this);
        m_nh_system[7] = private_nh_.advertiseService("system/get_current_solution_space", &DRHWInterface_SIM::get_current_solution_space_cb, this);
        m_nh_system[8] = private_nh_.advertiseService("system/set_safe_stop_reset_type", &DRHWInterface_SIM::set_safe_stop_reset_type_cb, this);
        m_nh_system[9] = private_nh_.advertiseService("system/get_last_alarm", &DRHWInterface_SIM::get_last_alarm_cb, this);
        m_nh_system[10]= private_nh_.advertiseService("system/get_robot_state", &DRHWInterface_SIM::get_robot_state_cb, this);
        m_nh_system[11]= private_nh_.advertiseService("system/get_joint_torque", &DRHWInterface_SIM::get_joint_torque_cb, this);
        m_nh_system[12]= private_nh_.advertiseService("system/set_robot_control", &DRHWInterface_SIM::set_robot_control_cb, this);
        m_nh_system[13]= private_nh_.advertiseService("system/manage_access_control", &DRHWInterface_SIM::manage_access_control_cb, this);
        m_nh_system[14]= private_nh_.advertiseService("system/release_protective_stop", &DRHWInterface_SIM::release_protective_stop_cb, this);
        m_nh_system[15]= private_nh_.advertiseService("system/set_robot_safety_mode", &DRHWInterface_SIM::set_robot_safety_mode_cb, this);

        //  motion Operations
        m_nh_motion_service[0] = private_nh_.advertiseService("motion/move_joint", &DRHWInterface_SIM::movej_cb, this);
        m_nh_motion_service[1] = private_nh_.advertiseService("motion/move_line", &DRHWInterface_SIM::movel_cb, this);
        m_nh_motion_service[2] = private_nh_.advertiseService("motion/move_jointx", &DRHWInterface_SIM::movejx_cb, this);
        m_nh_motion_service[3] = private_nh_.advertiseService("motion/move_circle", &DRHWInterface_SIM::movec_cb, this);
        m_nh_motion_service[4] = private_nh_.advertiseService("motion/move_spline_joint", &DRHWInterface_SIM::movesj_cb, this);
        m_nh_motion_service[5] = private_nh_.advertiseService("motion/move_spline_task", &DRHWInterface_SIM::movesx_cb, this);
        m_nh_motion_service[6] = private_nh_.advertiseService("motion/move_blending", &DRHWInterface_SIM::moveb_cb, this);
        m_nh_motion_service[7] = private_nh_.advertiseService("motion/move_spiral", &DRHWInterface_SIM::movespiral_cb, this);
        m_nh_motion_service[8] = private_nh_.advertiseService("motion/move_periodic", &DRHWInterface_SIM::moveperiodic_cb, this);
        m_nh_motion_service[9] = private_nh_.advertiseService("motion/move_wait", &DRHWInterface_SIM::movewait_cb, this);
        m_nh_motion_service[10]= private_nh_.advertiseService("motion/jog", &DRHWInterface_SIM::jog_cb, this);
        m_nh_motion_service[11]= private_nh_.advertiseService("motion/jog_multi", &DRHWInterface_SIM::jog_multi_cb, this);
        m_nh_motion_service[12]= private_nh_.advertiseService("motion/move_stop", &DRHWInterface_SIM::move_stop_cb, this);
        m_nh_motion_service[13]= private_nh_.advertiseService("motion/move_pause", &DRHWInterface_SIM::move_pause_cb, this);
        m_nh_motion_service[14]= private_nh_.advertiseService("motion/move_resume", &DRHWInterface_SIM::move_resume_cb, this);
        m_nh_motion_service[15]= private_nh_.advertiseService("motion/trans", &DRHWInterface_SIM::trans_cb, this);
        m_nh_motion_service[16]= private_nh_.advertiseService("motion/fkin", &DRHWInterface_SIM::fkin_cb, this);
        m_nh_motion_service[17]= private_nh_.advertiseService("motion/ikin", &DRHWInterface_SIM::ikin_cb, this);
        m_nh_motion_service[18]= private_nh_.advertiseService("motion/set_ref_coord", &DRHWInterface_SIM::set_ref_coord_cb, this);
        m_nh_motion_service[19]= private_nh_.advertiseService("motion/move_home", &DRHWInterface_SIM::move_home_cb, this);
        m_nh_motion_service[20]= private_nh_.advertiseService("motion/check_motion", &DRHWInterface_SIM::check_motion_cb, this);
        m_nh_motion_service[21]= private_nh_.advertiseService("motion/change_operation_speed", &DRHWInterface_SIM::change_operation_speed_cb, this);
        m_nh_motion_service[22]= private_nh_.advertiseService("motion/enable_alter_motion", &DRHWInterface_SIM::enable_alter_motion_cb, this);
        m_nh_motion_service[23]= private_nh_.advertiseService("motion/alter_motion", &DRHWInterface_SIM::alter_motion_cb, this);
        m_nh_motion_service[24]= private_nh_.advertiseService("motion/disable_alter_motion", &DRHWInterface_SIM::disable_alter_motion_cb, this);
        m_nh_motion_service[25]= private_nh_.advertiseService("motion/set_singularity_handling", &DRHWInterface_SIM::set_singularity_handling_cb, this);
        m_nh_motion_service[26]= private_nh_.advertiseService("motion/ikin_ex", &DRHWInterface_SIM::ikin_ex_cb, this);

        // Auxiliary Control Operations
        m_nh_aux_control_service[0]  = private_nh_.advertiseService("aux_control/get_control_mode", &DRHWInterface_SIM::get_control_mode_cb, this);
        m_nh_aux_control_service[1]  = private_nh_.advertiseService("aux_control/get_control_space", &DRHWInterface_SIM::get_control_space_cb, this);

        m_nh_aux_control_service[2]  = private_nh_.advertiseService("aux_control/get_current_posj", &DRHWInterface_SIM::get_current_posj_cb, this);
        m_nh_aux_control_service[3]  = private_nh_.advertiseService("aux_control/get_current_velj", &DRHWInterface_SIM::get_current_velj_cb, this);
        m_nh_aux_control_service[4]  = private_nh_.advertiseService("aux_control/get_desired_posj", &DRHWInterface_SIM::get_desired_posj_cb, this);
        m_nh_aux_control_service[5]  = private_nh_.advertiseService("aux_control/get_desired_velj", &DRHWInterface_SIM::get_desired_velj_cb, this);

        m_nh_aux_control_service[6]  = private_nh_.advertiseService("aux_control/get_current_posx", &DRHWInterface_SIM::get_current_posx_cb, this);
        m_nh_aux_control_service[7]  = private_nh_.advertiseService("aux_control/get_current_velx", &DRHWInterface_SIM::get_current_velx_cb, this);
        m_nh_aux_control_service[8]  = private_nh_.advertiseService("aux_control/get_desired_posx", &DRHWInterface_SIM::get_desired_posx_cb, this);
        m_nh_aux_control_service[9]  = private_nh_.advertiseService("aux_control/get_desired_velx", &DRHWInterface_SIM::get_desired_velx_cb, this);

        m_nh_aux_control_service[10]  = private_nh_.advertiseService("aux_control/get_current_tool_flange_posx", &DRHWInterface_SIM::get_current_tool_flange_posx_cb, this);
        m_nh_aux_control_service[11] = private_nh_.advertiseService("aux_control/get_current_solution_space", &DRHWInterface_SIM::get_current_solution_space_cb, this);
        m_nh_aux_control_service[12] = private_nh_.advertiseService("aux_control/get_current_rotm", &DRHWInterface_SIM::get_current_rotm_cb, this);
        m_nh_aux_control_service[13] = private_nh_.advertiseService("aux_control/get_joint_torque", &DRHWInterface_SIM::get_joint_torque_cb, this);
        m_nh_aux_control_service[14] = private_nh_.advertiseService("aux_control/get_external_torque", &DRHWInterface_SIM::get_external_torque_cb, this);
        m_nh_aux_control_service[15] = private_nh_.advertiseService("aux_control/get_tool_force", &DRHWInterface_SIM::get_tool_force_cb, this);
        m_nh_aux_control_service[16] = private_nh_.advertiseService("aux_control/get_solution_space", &DRHWInterface_SIM::get_solution_space_cb, this);
        m_nh_aux_control_service[17] = private_nh_.advertiseService("aux_control/get_orientation_error", &DRHWInterface_SIM::get_orientation_error_cb, this);


        //force & stiffness
        m_nh_force_service[0] = private_nh_.advertiseService("force/parallel_axis1", &DRHWInterface_SIM::parallel_axis1_cb, this);
        m_nh_force_service[1] = private_nh_.advertiseService("force/parallel_axis2", &DRHWInterface_SIM::parallel_axis2_cb, this);
        m_nh_force_service[2] = private_nh_.advertiseService("force/align_axis1", &DRHWInterface_SIM::align_axis1_cb, this);
        m_nh_force_service[3] = private_nh_.advertiseService("force/align_axis2", &DRHWInterface_SIM::align_axis2_cb, this);
        m_nh_force_service[4] = private_nh_.advertiseService("force/is_done_bolt_tightening", &DRHWInterface_SIM::is_done_bolt_tightening_cb, this);
        m_nh_force_service[5] = private_nh_.advertiseService("force/release_compliance_ctrl", &DRHWInterface_SIM::release_compliance_ctrl_cb, this);
        m_nh_force_service[6] = private_nh_.advertiseService("force/task_compliance_ctrl", &DRHWInterface_SIM::task_compliance_ctrl_cb, this);
        m_nh_force_service[7] = private_nh_.advertiseService("force/set_stiffnessx", &DRHWInterface_SIM::set_stiffnessx_cb, this);
        m_nh_force_service[8] = private_nh_.advertiseService("force/calc_coord", &DRHWInterface_SIM::calc_coord_cb, this);
        m_nh_force_service[9] = private_nh_.advertiseService("force/set_user_cart_coord1", &DRHWInterface_SIM::set_user_cart_coord1_cb, this);
        m_nh_force_service[10]= private_nh_.advertiseService("force/set_user_cart_coord2", &DRHWInterface_SIM::set_user_cart_coord2_cb, this);
        m_nh_force_service[11]= private_nh_.advertiseService("force/set_user_cart_coord3", &DRHWInterface_SIM::set_user_cart_coord3_cb, this);
        m_nh_force_service[12]= private_nh_.advertiseService("force/overwrite_user_cart_coord", &DRHWInterface_SIM::overwrite_user_cart_coord_cb, this);
        m_nh_force_service[13]= private_nh_.advertiseService("force/get_user_cart_coord", &DRHWInterface_SIM::get_user_cart_coord_cb, this);
        m_nh_force_service[14]= private_nh_.advertiseService("force/set_desired_force", &DRHWInterface_SIM::set_desired_force_cb, this);
        m_nh_force_service[15]= private_nh_.advertiseService("force/release_force", &DRHWInterface_SIM::release_force_cb, this);
        m_nh_force_service[16]= private_nh_.advertiseService("force/check_position_condition", &DRHWInterface_SIM::check_position_condition_cb, this);
        m_nh_force_service[17]= private_nh_.advertiseService("force/check_force_condition", &DRHWInterface_SIM::check_force_condition_cb, this);
        m_nh_force_service[18]= private_nh_.advertiseService("force/check_orientation_condition1", &DRHWInterface_SIM::check_orientation_condition1_cb, this);
        m_nh_force_service[19]= private_nh_.advertiseService("force/check_orientation_condition2", &DRHWInterface_SIM::check_orientation_condition2_cb, this);
        m_nh_force_service[20]= private_nh_.advertiseService("force/coord_transform", &DRHWInterface_SIM::coord_transform_cb, this);
        m_nh_force_service[21]= private_nh_.advertiseService("force/get_workpiece_weight", &DRHWInterface_SIM::get_workpiece_weight_cb, this);
        m_nh_force_service[22]= private_nh_.advertiseService("force/reset_workpiece_weight", &DRHWInterface_SIM::reset_workpiece_weight_cb, this);

        //  GPIO Operations
        m_nh_io_service[0] = private_nh_.advertiseService("io/set_digital_output", &DRHWInterface_SIM::set_digital_output_cb, this);
        m_nh_io_service[1] = private_nh_.advertiseService("io/get_digital_input", &DRHWInterface_SIM::get_digital_input_cb, this);
        m_nh_io_service[2] = private_nh_.advertiseService("io/set_tool_digital_output", &DRHWInterface_SIM::set_tool_digital_output_cb, this);
        m_nh_io_service[3] = private_nh_.advertiseService("io/get_tool_digital_input", &DRHWInterface_SIM::get_tool_digital_input_cb, this);
        m_nh_io_service[4] = private_nh_.advertiseService("io/set_analog_output", &DRHWInterface_SIM::set_analog_output_cb, this);
        m_nh_io_service[5] = private_nh_.advertiseService("io/get_analog_input", &DRHWInterface_SIM::get_analog_input_cb, this);
        m_nh_io_service[6] = private_nh_.advertiseService("io/set_analog_output_type", &DRHWInterface_SIM::set_analog_output_type_cb, this);
        m_nh_io_service[7] = private_nh_.advertiseService("io/set_analog_input_type", &DRHWInterface_SIM::set_analog_input_type_cb, this);
        m_nh_io_service[8] = private_nh_.advertiseService("io/get_digital_output", &DRHWInterface_SIM::get_digital_output_cb, this);
        m_nh_io_service[9] = private_nh_.advertiseService("io/get_tool_digital_output", &DRHWInterface_SIM::get_tool_digital_output_cb, this);

        //  Modbus Operations
        m_nh_modbus_service[0] = private_nh_.advertiseService("modbus/set_modbus_output", &DRHWInterface_SIM::set_modbus_output_cb, this);
        m_nh_modbus_service[1] = private_nh_.advertiseService("modbus/get_modbus_input", &DRHWInterface_SIM::get_modbus_input_cb, this);
        m_nh_modbus_service[2] = private_nh_.advertiseService("modbus/config_create_modbus", &DRHWInterface_SIM::config_create_modbus_cb, this);
        m_nh_modbus_service[3] = private_nh_.advertiseService("modbus/config_delete_modbus", &DRHWInterface_SIM::config_delete_modbus_cb, this);

        // TCP Operations
        m_nh_tcp_service[0] = private_nh_.advertiseService("tcp/set_current_tcp", &DRHWInterface_SIM::set_current_tcp_cb, this);
        m_nh_tcp_service[1] = private_nh_.advertiseService("tcp/get_current_tcp", &DRHWInterface_SIM::get_current_tcp_cb, this);
        m_nh_tcp_service[2] = private_nh_.advertiseService("tcp/config_create_tcp", &DRHWInterface_SIM::config_create_tcp_cb, this);
        m_nh_tcp_service[3] = private_nh_.advertiseService("tcp/config_delete_tcp", &DRHWInterface_SIM::config_delete_tcp_cb, this);

        // Tool Operations
        m_nh_tool_service[0] = private_nh_.advertiseService("tool/set_current_tool", &DRHWInterface_SIM::set_current_tool_cb, this);
        m_nh_tool_service[1] = private_nh_.advertiseService("tool/get_current_tool", &DRHWInterface_SIM::get_current_tool_cb, this);
        m_nh_tool_service[2] = private_nh_.advertiseService("tool/config_create_tool", &DRHWInterface_SIM::config_create_tool_cb, this);
        m_nh_tool_service[3] = private_nh_.advertiseService("tool/config_delete_tool", &DRHWInterface_SIM::config_delete_tool_cb, this);
        m_nh_tool_service[4] = private_nh_.advertiseService("tool/set_tool_shape", &DRHWInterface_SIM::set_tool_shape_cb, this);

        // DRL Operations
        m_nh_drl_service[0] = private_nh_.advertiseService("drl/drl_pause", &DRHWInterface_SIM::drl_pause_cb, this);
        m_nh_drl_service[1] = private_nh_.advertiseService("drl/drl_resume", &DRHWInterface_SIM::drl_resume_cb, this);
        m_nh_drl_service[2] = private_nh_.advertiseService("drl/drl_start", &DRHWInterface_SIM::drl_start_cb, this);
        m_nh_drl_service[3] = private_nh_.advertiseService("drl/drl_stop", &DRHWInterface_SIM::drl_stop_cb, this);
        m_nh_drl_service[4] = private_nh_.advertiseService("drl/get_drl_state", &DRHWInterface_SIM::get_drl_state_cb, this);

        // Gripper Operations
        m_nh_gripper_service[0] = private_nh_.advertiseService("gripper/robotiq_2f_open", &DRHWInterface_SIM::robotiq_2f_open_cb, this);
        m_nh_gripper_service[1] = private_nh_.advertiseService("gripper/robotiq_2f_close", &DRHWInterface_SIM::robotiq_2f_close_cb, this);
        m_nh_gripper_service[2] = private_nh_.advertiseService("gripper/robotiq_2f_move", &DRHWInterface_SIM::robotiq_2f_move_cb, this);

        // Serial Operations
        m_nh_serial_service[0] = private_nh_.advertiseService("gripper/serial_send_data", &DRHWInterface_SIM::serial_send_data_cb, this);

        // Realtime Operations
        m_nh_realtime_service[0] = private_nh_.advertiseService("realtime/connect_rt_control", &DRHWInterface_SIM::connect_rt_control_cb, this);
        m_nh_realtime_service[1] = private_nh_.advertiseService("realtime/disconnect_rt_control", &DRHWInterface_SIM::disconnect_rt_control_cb, this);
        m_nh_realtime_service[2] = private_nh_.advertiseService("realtime/get_rt_control_output_version_list", &DRHWInterface_SIM::get_rt_control_output_version_list_cb, this);
        m_nh_realtime_service[3] = private_nh_.advertiseService("realtime/get_rt_control_input_version_list", &DRHWInterface_SIM::get_rt_control_input_version_list_cb, this);
        m_nh_realtime_service[4] = private_nh_.advertiseService("realtime/get_rt_control_input_data_list", &DRHWInterface_SIM::get_rt_control_input_data_list_cb, this);
        m_nh_realtime_service[5] = private_nh_.advertiseService("realtime/get_rt_control_output_data_list", &DRHWInterface_SIM::get_rt_control_output_data_list_cb, this);
        m_nh_realtime_service[6] = private_nh_.advertiseService("realtime/set_rt_control_input", &DRHWInterface_SIM::set_rt_control_input_cb, this);
        m_nh_realtime_service[7] = private_nh_.advertiseService("realtime/set_rt_control_output", &DRHWInterface_SIM::set_rt_control_output_cb, this);
        m_nh_realtime_service[8] = private_nh_.advertiseService("realtime/start_rt_control", &DRHWInterface_SIM::start_rt_control_cb, this);
        m_nh_realtime_service[9] = private_nh_.advertiseService("realtime/stop_rt_control", &DRHWInterface_SIM::stop_rt_control_cb, this);
        m_nh_realtime_service[10] = private_nh_.advertiseService("realtime/set_velj_rt", &DRHWInterface_SIM::set_velj_rt_cb, this);
        m_nh_realtime_service[11] = private_nh_.advertiseService("realtime/set_accj_rt", &DRHWInterface_SIM::set_accj_rt_cb, this);
        m_nh_realtime_service[12] = private_nh_.advertiseService("realtime/set_velx_rt", &DRHWInterface_SIM::set_velx_rt_cb, this);
        m_nh_realtime_service[13] = private_nh_.advertiseService("realtime/set_accx_rt", &DRHWInterface_SIM::set_accx_rt_cb, this);
        m_nh_realtime_service[14] = private_nh_.advertiseService("realtime/read_data_rt", &DRHWInterface_SIM::read_data_rt_cb, this);
        m_nh_realtime_service[15] = private_nh_.advertiseService("realtime/write_data_rt", &DRHWInterface_SIM::write_data_rt_cb, this);
    ...
    DRHWInterface_SIM::~DRHWInterface_SIM()
    {
        //ROS_INFO("DRHWInterface_SIM::~DRHWInterface_SIM() 0");
        Drfl.stop_rt_control();
        Drfl.close_connection();

        //ROS_INFO("DRHWInterface_SIM::~DRHWInterface_SIM() 1");
        m_th_publisher.join();   //kill publisher thread
        //ROS_INFO("DRHWInterface_SIM::~DRHWInterface_SIM() 2");

        m_th_subscribe.join();   //kill subscribe thread
        ROS_INFO("DRHWInterface_SIM::~DRHWInterface_SIM()");
    }

    bool DRHWInterface_SIM::init()
    {
        ...
        private_nh_.getParam("port_rt", nUDPPort);
        ...
        ROS_INFO("host %s, port=%d, port_rt=%d, bCommand: %d, mode: %s\n", host.c_str(), nServerPort, nUDPPort, bCommand_, mode.c_str());
        ...
        if(Drfl.open_connection(host, nServerPort))
        {
            ...
            //--- Connect RT Controller
            Drfl.connect_rt_control(host,nUDPPort);
            string version = "v1.0";
            float period = 0.001;
            int losscount = 4;
    ...
    void DRHWInterface_SIM::read(ros::Duration& elapsed_time)
    {
        std_msgs::Float64MultiArray msg;
        // joints.pos, vel, eff should be update
        //ROS_DEBUG("DRHWInterface_SIM::read()");
        LPROBOT_POSE pose = Drfl.GetCurrentPose();
        for(int i = 0; i < NUM_JOINT; i++){
            ROS_DEBUG("[DRHWInterface_SIM::read] %d-pos: %7.3f", i, pose->_fPosition[i]);
    ...
    void DRHWInterface_SIM::write(ros::Duration& elapsed_time)
    {
        //ROS_INFO("DRHWInterface_SIM::write()");
        static int count = 0;
    ...
    //----- SIG Handler --------------------------------------------------------------
    void DRHWInterface_SIM::sigint_handler(int signo)
    {
        ROS_INFO("SIG HANDLER !!!!!!!!!");

        ros::NodeHandlePtr node = boost::make_shared<ros::NodeHandle>();
        ros::Publisher pubRobotStop = node->advertise<dsr_sim_msgs::RobotStop>("/"+m_strRobotName +m_strRobotModel+"/stop",100);

        dsr_sim_msgs::RobotStop msg;
    ...
    void DRHWInterface_SIM::positionCallback(const std_msgs::Float64MultiArray::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::jogCallback(const dsr_sim_msgs::JogMultiAxis::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::alterCallback(const dsr_sim_msgs::AlterMotionStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::servojCallback(const dsr_sim_msgs::ServoJStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::servolCallback(const dsr_sim_msgs::ServoLStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::speedjCallback(const dsr_sim_msgs::SpeedJStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::speedlCallback(const dsr_sim_msgs::SpeedLStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::servojRTCallback(const dsr_sim_msgs::ServoJRTStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::servolRTCallback(const dsr_sim_msgs::ServoLRTStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::speedjRTCallback(const dsr_sim_msgs::SpeedJRTStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::speedlRTCallback(const dsr_sim_msgs::SpeedLRTStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::torqueRTCallback(const dsr_sim_msgs::TorqueRTStream::ConstPtr& msg){
    ...
    void DRHWInterface_SIM::trajectoryCallback(const control_msgs::FollowJointTrajectoryActionGoal::ConstPtr& msg)
    {
        ...
        {
            ROS_INFO("DRHWInterface_SIM::trajectoryCallback over max Trajectory (%d > %d)",nCntTargetPos ,MAX_SPLINE_POINT);
            return;
        }
    ...
    bool DRHWInterface_SIM::set_robot_mode_cb(dsr_sim_msgs::SetRobotMode::Request& req, dsr_sim_msgs::SetRobotMode::Response& res){
        res.success = false;
        res.success = Drfl.set_robot_mode((ROBOT_MODE)req.robot_mode);
        return true;
    }

    bool DRHWInterface_SIM::get_robot_mode_cb(dsr_sim_msgs::GetRobotMode::Request& req, dsr_sim_msgs::GetRobotMode::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_robot_system_cb(dsr_sim_msgs::SetRobotSystem::Request& req, dsr_sim_msgs::SetRobotSystem::Response& res){
        res.success = false;
        res.success = Drfl.set_robot_system((ROBOT_SYSTEM)req.robot_system);
        return true;
    }
    bool DRHWInterface_SIM::get_robot_system_cb(dsr_sim_msgs::GetRobotSystem::Request& req, dsr_sim_msgs::GetRobotSystem::Response& res){
        res.success = false;
        res.robot_system = Drfl.get_robot_system();
        res.success = true;
        return true;
    }
    bool DRHWInterface_SIM::get_robot_state_cb(dsr_sim_msgs::GetRobotState::Request& req, dsr_sim_msgs::GetRobotState::Response& res){
        res.success = false;
        res.robot_state = Drfl.get_robot_state();
        return true;
    }
    bool DRHWInterface_SIM::set_robot_speed_mode_cb(dsr_sim_msgs::SetRobotSpeedMode::Request& req, dsr_sim_msgs::SetRobotSpeedMode::Response& res){
        res.success = false;
        res.success = Drfl.set_robot_speed_mode((SPEED_MODE)req.speed_mode);
        return true;
    }
    bool DRHWInterface_SIM::get_robot_speed_mode_cb(dsr_sim_msgs::GetRobotSpeedMode::Request& req, dsr_sim_msgs::GetRobotSpeedMode::Response& res){
        res.success = false;
        res.speed_mode = Drfl.get_robot_speed_mode();
        res.success = true;
        return true;
    }
    bool DRHWInterface_SIM::get_current_pose_cb(dsr_sim_msgs::GetCurrentPose::Request& req, dsr_sim_msgs::GetCurrentPose::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_safe_stop_reset_type_cb(dsr_sim_msgs::SetSafeStopResetType::Request& req, dsr_sim_msgs::SetSafeStopResetType::Response& res){
        res.success = false;
        Drfl.SetSafeStopResetType((SAFE_STOP_RESET_TYPE)req.reset_type);
        res.success = true;
        return true;
    }
    bool DRHWInterface_SIM::get_last_alarm_cb(dsr_sim_msgs::GetLastAlarm::Request& req, dsr_sim_msgs::GetLastAlarm::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_robot_control_cb(dsr_sim_msgs::SetRobotControl::Request& req, dsr_sim_msgs::SetRobotControl::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::manage_access_control_cb(dsr_sim_msgs::ManageAccessControl::Request& req, dsr_sim_msgs::ManageAccessControl::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::release_protective_stop_cb(dsr_sim_msgs::ReleaseProtectiveStop::Request& req, dsr_sim_msgs::ReleaseProtectiveStop::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_robot_safety_mode_cb(dsr_sim_msgs::SetRobotSafetyMode::Request& req, dsr_sim_msgs::SetRobotSafetyMode::Response& res){
        res.success = false;
    ...
    bool DRHWInterface_SIM::movej_cb(dsr_sim_msgs::MoveJoint::Request& req, dsr_sim_msgs::MoveJoint::Response& res)
    {
        res.success = false;
        std::array<float, NUM_JOINT> target_pos;
        std::copy(req.pos.cbegin(), req.pos.cend(), target_pos.begin());
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movej_cb() called and calling Drfl.MoveJ");
            ...
            //ROS_INFO("DRHWInterface_SIM::movej_cb() called and calling Drfl.MoveJAsync");
            res.success = Drfl.amovej(target_pos.data(), req.vel, req.acc, req.time, (MOVE_MODE)req.mode, (BLENDING_SPEED_TYPE)req.blendType);
        }
        return true;
    }
    bool DRHWInterface_SIM::movel_cb(dsr_sim_msgs::MoveLine::Request& req, dsr_sim_msgs::MoveLine::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> target_pos;
        std::array<float, 2> target_vel;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movel_cb() called and calling Drfl.MoveL");
            ...
            //ROS_INFO("DRHWInterface_SIM::movel_cb() called and calling Drfl.MoveLAsync");
    ...
    bool DRHWInterface_SIM::movejx_cb(dsr_sim_msgs::MoveJointx::Request& req, dsr_sim_msgs::MoveJointx::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> target_pos;
        std::copy(req.pos.cbegin(), req.pos.cend(), target_pos.begin());
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movejx_cb() called and calling Drfl.MoveJX");
            ...
            //ROS_INFO("DRHWInterface_SIM::movejx_cb() called and calling Drfl.MoveJXAsync");
    ...
    bool DRHWInterface_SIM::movec_cb(dsr_sim_msgs::MoveCircle::Request& req, dsr_sim_msgs::MoveCircle::Response& res)
    {
        res.success = false;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movec_cb() called and calling Drfl.MoveC");
            ...
            //ROS_INFO("DRHWInterface_SIM::movec_cb() called and calling Drfl.MoveCAsync");
    ...
    bool DRHWInterface_SIM::movesj_cb(dsr_sim_msgs::MoveSplineJoint::Request& req, dsr_sim_msgs::MoveSplineJoint::Response& res)
    {
        res.success = false;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movesj_cb() called and calling Drfl.MoveSJ");
            res.success = Drfl.movesj(fTargetPos, req.posCnt, fTargetVel, fTargetAcc, req.time, (MOVE_MODE)req.mode);
        }
        else{
            //ROS_INFO("DRHWInterface_SIM::movesj_cb() called and calling Drfl.MoveSJAsync");
            res.success = Drfl.amovesj(fTargetPos, req.posCnt, fTargetVel, fTargetAcc, req.time, (MOVE_MODE)req.mode);
        }
        return true;
    }
    bool DRHWInterface_SIM::movesx_cb(dsr_sim_msgs::MoveSplineTask::Request& req, dsr_sim_msgs::MoveSplineTask::Response& res)
    {
        res.success = false;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movesx_cb() called and calling Drfl.MoveSX");
            ...
            //ROS_INFO("DRHWInterface_SIM::movesx_cb() called and calling Drfl.MoveSXAsync");
    ...
    bool DRHWInterface_SIM::moveb_cb(dsr_sim_msgs::MoveBlending::Request& req, dsr_sim_msgs::MoveBlending::Response& res)
    {
        res.success = false;
        ...
        */
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::moveb_cb() called and calling Drfl.MoveB");
            ...
            //ROS_INFO("DRHWInterface_SIM::moveb_cb() called and calling Drfl.MoveBAsync");
    ...
    bool DRHWInterface_SIM::movespiral_cb(dsr_sim_msgs::MoveSpiral::Request& req, dsr_sim_msgs::MoveSpiral::Response& res)
    {
        res.success = false;
        std::array<float, 2> target_vel;
        std::array<float, 2> target_acc;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::movespiral_cb() called and calling Drfl.MoveSpiral");
            ...
            //ROS_INFO("DRHWInterface_SIM::movespiral_cb() called and calling Drfl.MoveSpiralAsync");
    ...
    bool DRHWInterface_SIM::moveperiodic_cb(dsr_sim_msgs::MovePeriodic::Request& req, dsr_sim_msgs::MovePeriodic::Response& res)
    {
        res.success = false;
        ...
        if(req.syncType == 0){
            //ROS_INFO("DRHWInterface_SIM::moveperiodic_cb() called and calling Drfl.MovePeriodic");
            res.success = Drfl.move_periodic(target_amp.data(), target_periodic.data(), req.acc, req.repeat, (MOVE_REFERENCE)req.ref);
        }
        else{
            //ROS_INFO("DRHWInterface_SIM::moveperiodic_cb() called and calling Drfl.MovePeriodicAsync");
            res.success = Drfl.amove_periodic(target_amp.data(), target_periodic.data(), req.acc, req.repeat, (MOVE_REFERENCE)req.ref);
        }
        return true;
    }

    bool DRHWInterface_SIM::movewait_cb(dsr_sim_msgs::MoveWait::Request& req, dsr_sim_msgs::MoveWait::Response& res)
    {
        res.success = false;
        //ROS_INFO("DRHWInterface_SIM::movewait_cb() called and calling Drfl.MoveWait");
        res.success = Drfl.mwait();
        return true;
    }

    bool DRHWInterface_SIM::jog_cb(dsr_sim_msgs::Jog::Request& req, dsr_sim_msgs::Jog::Response& res)
    {
        res.success = false;
        ROS_INFO("DRHWInterface_SIM::jog_cb() called and calling Drfl.Jog");
    ...
    bool DRHWInterface_SIM::jog_multi_cb(dsr_sim_msgs::JogMulti::Request& req, dsr_sim_msgs::JogMulti::Response& res)
    {
        res.success = false;
        ROS_INFO("DRHWInterface_SIM::jog_multi_cb() called and calling Drfl.MultiJog");
    ...
    bool DRHWInterface_SIM::move_stop_cb(dsr_sim_msgs::MoveStop::Request& req, dsr_sim_msgs::MoveStop::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::move_resume_cb(dsr_sim_msgs::MoveResume::Request& req, dsr_sim_msgs::MoveResume::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::move_pause_cb(dsr_sim_msgs::MovePause::Request& req, dsr_sim_msgs::MovePause::Response& res)
    {
        res.success = false;
        res.success = Drfl.move_pause();
        return true;
    }
    bool DRHWInterface_SIM::trans_cb(dsr_sim_msgs::Trans::Request& req, dsr_sim_msgs::Trans::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> target_pos;
    ...
    bool DRHWInterface_SIM::fkin_cb(dsr_sim_msgs::Fkin::Request& req, dsr_sim_msgs::Fkin::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::ikin_cb(dsr_sim_msgs::Ikin::Request& req, dsr_sim_msgs::Ikin::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::ikin_ex_cb(dsr_sim_msgs::IkinEx::Request& req, dsr_sim_msgs::IkinEx::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
        std::copy(req.pos.cbegin(), req.pos.cend(), task_pos.begin());
    ...
    bool DRHWInterface_SIM::set_ref_coord_cb(dsr_sim_msgs::SetRefCoord::Request& req, dsr_sim_msgs::SetRefCoord::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::move_home_cb(dsr_sim_msgs::MoveHome::Request& req, dsr_sim_msgs::MoveHome::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::check_motion_cb(dsr_sim_msgs::CheckMotion::Request& req, dsr_sim_msgs::CheckMotion::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::change_operation_speed_cb(dsr_sim_msgs::ChangeOperationSpeed::Request& req, dsr_sim_msgs::ChangeOperationSpeed::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::enable_alter_motion_cb(dsr_sim_msgs::EnableAlterMotion::Request& req, dsr_sim_msgs::EnableAlterMotion::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::alter_motion_cb(dsr_sim_msgs::AlterMotion::Request& req, dsr_sim_msgs::AlterMotion::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::disable_alter_motion_cb(dsr_sim_msgs::DisableAlterMotion::Request& req, dsr_sim_msgs::DisableAlterMotion::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::set_singularity_handling_cb(dsr_sim_msgs::SetSingularityHandling::Request& req, dsr_sim_msgs::SetSingularityHandling::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_control_mode_cb(dsr_sim_msgs::GetControlMode::Request& req, dsr_sim_msgs::GetControlMode::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_control_space_cb(dsr_sim_msgs::GetControlSpace::Request& req, dsr_sim_msgs::GetControlSpace::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_posj_cb(dsr_sim_msgs::GetCurrentPosj::Request& req, dsr_sim_msgs::GetCurrentPosj::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_velj_cb(dsr_sim_msgs::GetCurrentVelj::Request& req, dsr_sim_msgs::GetCurrentVelj::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_desired_posj_cb(dsr_sim_msgs::GetDesiredPosj::Request& req, dsr_sim_msgs::GetDesiredPosj::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_desired_velj_cb(dsr_sim_msgs::GetDesiredVelj::Request& req, dsr_sim_msgs::GetDesiredVelj::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_posx_cb(dsr_sim_msgs::GetCurrentPosx::Request& req, dsr_sim_msgs::GetCurrentPosx::Response& res)
    {
        res.success = false;
        std_msgs::Float64MultiArray arr;
    ...
    bool DRHWInterface_SIM::get_current_velx_cb(dsr_sim_msgs::GetCurrentVelx::Request& req, dsr_sim_msgs::GetCurrentVelx::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_desired_posx_cb(dsr_sim_msgs::GetDesiredPosx::Request& req, dsr_sim_msgs::GetDesiredPosx::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_desired_velx_cb(dsr_sim_msgs::GetDesiredVelx::Request& req, dsr_sim_msgs::GetDesiredVelx::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_tool_flange_posx_cb(dsr_sim_msgs::GetCurrentToolFlangePosx::Request& req, dsr_sim_msgs::GetCurrentToolFlangePosx::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_solution_space_cb(dsr_sim_msgs::GetCurrentSolutionSpace::Request& req, dsr_sim_msgs::GetCurrentSolutionSpace::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_current_rotm_cb(dsr_sim_msgs::GetCurrentRotm::Request& req, dsr_sim_msgs::GetCurrentRotm::Response& res)
    {
        res.success = false;
        std_msgs::Float64MultiArray arr;
    ...
    bool DRHWInterface_SIM::get_joint_torque_cb(dsr_sim_msgs::GetJointTorque::Request& req, dsr_sim_msgs::GetJointTorque::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_external_torque_cb(dsr_sim_msgs::GetExternalTorque::Request& req, dsr_sim_msgs::GetExternalTorque::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_tool_force_cb(dsr_sim_msgs::GetToolForce::Request& req, dsr_sim_msgs::GetToolForce::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::get_solution_space_cb(dsr_sim_msgs::GetSolutionSpace::Request& req, dsr_sim_msgs::GetSolutionSpace::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
        std::copy(req.pos.cbegin(), req.pos.cend(), task_pos.begin());
    ...
    bool DRHWInterface_SIM::get_orientation_error_cb(dsr_sim_msgs::GetOrientationError::Request& req, dsr_sim_msgs::GetOrientationError::Response& res)
    {
        res.success = false;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool DRHWInterface_SIM::get_workpiece_weight_cb(dsr_sim_msgs::GetWorkpieceWeight::Request& req, dsr_sim_msgs::GetWorkpieceWeight::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::reset_workpiece_weight_cb(dsr_sim_msgs::ResetWorkpieceWeight::Request& req, dsr_sim_msgs::ResetWorkpieceWeight::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    bool DRHWInterface_SIM::parallel_axis1_cb(dsr_sim_msgs::ParallelAxis1::Request& req, dsr_sim_msgs::ParallelAxis1::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos1;
        std::array<float, NUM_TASK> task_pos2;
    ...
    bool DRHWInterface_SIM::parallel_axis2_cb(dsr_sim_msgs::ParallelAxis2::Request& req, dsr_sim_msgs::ParallelAxis2::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::align_axis1_cb(dsr_sim_msgs::AlignAxis1::Request& req, dsr_sim_msgs::AlignAxis1::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos1;
        std::array<float, NUM_TASK> task_pos2;
    ...
    bool DRHWInterface_SIM::align_axis2_cb(dsr_sim_msgs::AlignAxis2::Request& req, dsr_sim_msgs::AlignAxis2::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::is_done_bolt_tightening_cb(dsr_sim_msgs::IsDoneBoltTightening::Request& req, dsr_sim_msgs::IsDoneBoltTightening::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::release_compliance_ctrl_cb(dsr_sim_msgs::ReleaseComplianceCtrl::Request& req, dsr_sim_msgs::ReleaseComplianceCtrl::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::task_compliance_ctrl_cb(dsr_sim_msgs::TaskComplianceCtrl::Request& req, dsr_sim_msgs::TaskComplianceCtrl::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_stiffnessx_cb(dsr_sim_msgs::SetStiffnessx::Request& req, dsr_sim_msgs::SetStiffnessx::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> stiffnesses;
    ...
    bool DRHWInterface_SIM::calc_coord_cb(dsr_sim_msgs::CalcCoord::Request& req, dsr_sim_msgs::CalcCoord::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos1;
        std::array<float, NUM_TASK> task_pos2;
    ...
    bool DRHWInterface_SIM::set_user_cart_coord1_cb(dsr_sim_msgs::SetUserCartCoord1::Request& req, dsr_sim_msgs::SetUserCartCoord1::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
    ...
    bool DRHWInterface_SIM::set_user_cart_coord2_cb(dsr_sim_msgs::SetUserCartCoord2::Request& req, dsr_sim_msgs::SetUserCartCoord2::Response& res)
    {
        res.success = false;
        //std::array<float, NUM_TASK> task_pos1;
        //std::array<float, NUM_TASK> task_pos2;
    ...
    bool DRHWInterface_SIM::set_user_cart_coord3_cb(dsr_sim_msgs::SetUserCartCoord3::Request& req, dsr_sim_msgs::SetUserCartCoord3::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::overwrite_user_cart_coord_cb(dsr_sim_msgs::OverwriteUserCartCoord::Request& req, dsr_sim_msgs::OverwriteUserCartCoord::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
    ...
    bool DRHWInterface_SIM::get_user_cart_coord_cb(dsr_sim_msgs::GetUserCartCoord::Request& req, dsr_sim_msgs::GetUserCartCoord::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::set_desired_force_cb(dsr_sim_msgs::SetDesiredForce::Request& req, dsr_sim_msgs::SetDesiredForce::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::release_force_cb(dsr_sim_msgs::ReleaseForce::Request& req, dsr_sim_msgs::ReleaseForce::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::check_position_condition_cb(dsr_sim_msgs::CheckPositionCondition::Request& req, dsr_sim_msgs::CheckPositionCondition::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
        std::copy(req.pos.cbegin(), req.pos.cend(), task_pos.begin());
    ...
    bool DRHWInterface_SIM::check_force_condition_cb(dsr_sim_msgs::CheckForceCondition::Request& req, dsr_sim_msgs::CheckForceCondition::Response& res)
    {
        res.success = false;
    #if (_DEBUG_DSR_CTL)
    ...
    bool DRHWInterface_SIM::check_orientation_condition1_cb(dsr_sim_msgs::CheckOrientationCondition1::Request& req, dsr_sim_msgs::CheckOrientationCondition1::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos1;
        std::array<float, NUM_TASK> task_pos2;
    ...
    bool DRHWInterface_SIM::check_orientation_condition2_cb(dsr_sim_msgs::CheckOrientationCondition2::Request& req, dsr_sim_msgs::CheckOrientationCondition2::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
    ...
    bool DRHWInterface_SIM::coord_transform_cb(dsr_sim_msgs::CoordTransform::Request& req, dsr_sim_msgs::CoordTransform::Response& res)
    {
        res.success = false;
        std::array<float, NUM_TASK> task_pos;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    bool DRHWInterface_SIM::set_digital_output_cb(dsr_sim_msgs::SetCtrlBoxDigitalOutput::Request& req, dsr_sim_msgs::SetCtrlBoxDigitalOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_digital_output_cb() called and calling Drfl.SetCtrlBoxDigitalOutput");
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_digital_output_cb(dsr_sim_msgs::GetCtrlBoxDigitalOutput::Request& req, dsr_sim_msgs::GetCtrlBoxDigitalOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_digital_output_cb() called and calling Drfl.GetCtrlBoxDigitalOutput");
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_digital_input_cb(dsr_sim_msgs::GetCtrlBoxDigitalInput::Request& req, dsr_sim_msgs::GetCtrlBoxDigitalInput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_digital_input_cb() called and calling Drfl.GetCtrlBoxDigitalInput");
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_tool_digital_output_cb(dsr_sim_msgs::SetToolDigitalOutput::Request& req, dsr_sim_msgs::SetToolDigitalOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_tool_digital_output_cb() called and calling Drfl.SetToolDigitalOutput");
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_tool_digital_output_cb(dsr_sim_msgs::GetToolDigitalOutput::Request& req, dsr_sim_msgs::GetToolDigitalOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_tool_digital_output_cb() called and calling Drfl.GetToolDigitalOutput");
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_tool_digital_input_cb(dsr_sim_msgs::GetToolDigitalInput::Request& req, dsr_sim_msgs::GetToolDigitalInput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_tool_digital_input_cb() called and calling Drfl.GetToolDigitalInput");
        res.success = false;
        if((req.index < DR_TDIO_MIN_INDEX) || (req.index > DR_TDIO_MAX_INDEX)){
    ...
    bool DRHWInterface_SIM::set_analog_output_cb(dsr_sim_msgs::SetCtrlBoxAnalogOutput::Request& req, dsr_sim_msgs::SetCtrlBoxAnalogOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_analog_output_cb() called and calling Drfl.SetCtrlBoxAnalogOutput");
        res.success = false;
        bool bIsError = 0;
    ...
    bool DRHWInterface_SIM::get_analog_input_cb(dsr_sim_msgs::GetCtrlBoxAnalogInput::Request& req, dsr_sim_msgs::GetCtrlBoxAnalogInput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_analog_input_cb() called and calling Drfl.GetCtrlBoxAnalogInput");
        res.success = false;
        bool bIsError = 0;
    ...
    bool DRHWInterface_SIM::set_analog_output_type_cb(dsr_sim_msgs::SetCtrlBoxAnalogOutputType::Request& req, dsr_sim_msgs::SetCtrlBoxAnalogOutputType::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_analog_output_type_cb() called and calling Drfl.SetCtrlBoxAnalogOutputType");
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_analog_input_type_cb(dsr_sim_msgs::SetCtrlBoxAnalogInputType::Request& req, dsr_sim_msgs::SetCtrlBoxAnalogInputType::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_analog_input_type_cb() called and calling Drfl.SetCtrlBoxAnalogInputType");
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_modbus_output_cb(dsr_sim_msgs::SetModbusOutput::Request& req, dsr_sim_msgs::SetModbusOutput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_modbus_output_cb() called and calling Drfl.SetModbusOutput");
        res.success = false;
        res.success = Drfl.set_modbus_output(req.name, (unsigned short)req.value);
        return true;
    }
    bool DRHWInterface_SIM::get_modbus_input_cb(dsr_sim_msgs::GetModbusInput::Request& req, dsr_sim_msgs::GetModbusInput::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_modbus_input_cb() called and calling Drfl.GetModbusInput");
        res.value = Drfl.get_modbus_input(req.name);
        return true;
    }
    bool DRHWInterface_SIM::config_create_modbus_cb(dsr_sim_msgs::ConfigCreateModbus::Request& req, dsr_sim_msgs::ConfigCreateModbus::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_create_modbus_cb() called and calling Drfl.ConfigCreateModbus");
        res.success = false;
    ...
    bool DRHWInterface_SIM::config_delete_modbus_cb(dsr_sim_msgs::ConfigDeleteModbus::Request& req, dsr_sim_msgs::ConfigDeleteModbus::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_delete_modbus_cb() called and calling Drfl.ConfigDeleteModbus");
        res.success = false;
        res.success = Drfl.del_modbus_signal(req.name);
        return true;
    }
    bool DRHWInterface_SIM::drl_pause_cb(dsr_sim_msgs::DrlPause::Request& req, dsr_sim_msgs::DrlPause::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::drl_pause_cb() called and calling Drfl.DrlPause");
        res.success = false;
    ...
    bool DRHWInterface_SIM::drl_start_cb(dsr_sim_msgs::DrlStart::Request& req, dsr_sim_msgs::DrlStart::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::drl_start_cb() called and calling Drfl.DrlStart");
        res.success = false;
    ...
    bool DRHWInterface_SIM::drl_stop_cb(dsr_sim_msgs::DrlStop::Request& req, dsr_sim_msgs::DrlStop::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::drl_stop_cb() called and calling Drfl.DrlStop");
        res.success = false;
    ...
    bool DRHWInterface_SIM::drl_resume_cb(dsr_sim_msgs::DrlResume::Request& req, dsr_sim_msgs::DrlResume::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::drl_resume_cb() called and calling Drfl.DrlResume");
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_drl_state_cb(dsr_sim_msgs::GetDrlState::Request& req, dsr_sim_msgs::GetDrlState::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_current_tcp_cb(dsr_sim_msgs::SetCurrentTcp::Request& req, dsr_sim_msgs::SetCurrentTcp::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_current_tcp_cb() called and calling Drfl.SetCurrentTCP");
        res.success = false;
        res.success = Drfl.set_tcp(req.name);
        return true;
    }
    bool DRHWInterface_SIM::get_current_tcp_cb(dsr_sim_msgs::GetCurrentTcp::Request& req, dsr_sim_msgs::GetCurrentTcp::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_current_tcp_cb() called and calling Drfl.GetCurrentTCP");
        res.success = false;
        res.info = Drfl.get_tcp();
        res.success = true;
        return true;
    }
    bool DRHWInterface_SIM::config_create_tcp_cb(dsr_sim_msgs::ConfigCreateTcp::Request& req, dsr_sim_msgs::ConfigCreateTcp::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_create_tcp_cb() called and calling Drfl.ConfigCreateTCP");
        res.success = false;
    ...
    bool DRHWInterface_SIM::config_delete_tcp_cb(dsr_sim_msgs::ConfigDeleteTcp::Request& req, dsr_sim_msgs::ConfigDeleteTcp::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_delete_tcp_cb() called and calling Drfl.ConfigDeleteTCP");
        res.success = false;
        res.success = Drfl.del_tcp(req.name);
        return true;
    }

    bool DRHWInterface_SIM::set_current_tool_cb(dsr_sim_msgs::SetCurrentTool::Request& req, dsr_sim_msgs::SetCurrentTool::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::set_current_tool_cb() called and calling Drfl.SetCurrentTool");
        res.success = false;
        res.success = Drfl.set_tool(req.name);
        return true;
    }
    bool DRHWInterface_SIM::get_current_tool_cb(dsr_sim_msgs::GetCurrentTool::Request& req, dsr_sim_msgs::GetCurrentTool::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::get_current_tool_cb() called and calling Drfl.GetCurrentTool %s", Drfl.GetCurrentTool().c_str());
        res.success = false;
        res.info = Drfl.get_tool();
        res.success = true;
        return true;
    }
    bool DRHWInterface_SIM::config_create_tool_cb(dsr_sim_msgs::ConfigCreateTool::Request& req, dsr_sim_msgs::ConfigCreateTool::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_create_tool_cb() called and calling Drfl.ConfigCreateTool");
        res.success = false;
    ...
    bool DRHWInterface_SIM::config_delete_tool_cb(dsr_sim_msgs::ConfigDeleteTool::Request& req, dsr_sim_msgs::ConfigDeleteTool::Response& res)
    {
        //ROS_INFO("DRHWInterface_SIM::config_delete_tool_cb() called and calling Drfl.ConfigDeleteTool");
        res.success = false;
        res.success = Drfl.del_tool(req.name);
        return true;
    }
    bool DRHWInterface_SIM::set_tool_shape_cb(dsr_sim_msgs::SetToolShape::Request& req, dsr_sim_msgs::SetToolShape::Response& res)
    {
        res.success = false;
        res.success = Drfl.set_tool(req.name);
        return true;
    ...
    bool DRHWInterface_SIM::robotiq_2f_move_cb(dsr_sim_msgs::Robotiq2FMove::Request& req, dsr_sim_msgs::Robotiq2FMove::Response& res)
    {
        res.success = false;
        //ROS_INFO("DRHWInterface_SIM::gripper_move_cb() called and calling Nothing");
        /*
        if(mode == "robotiq_2f"){
    ...
    bool DRHWInterface_SIM::robotiq_2f_open_cb(dsr_sim_msgs::Robotiq2FOpen::Request& req, dsr_sim_msgs::Robotiq2FOpen::Response& res)
    {
        res.success = false;
        float goal_pos = 0.8;
        while(abs(goal_pos - joints[6].pos) > 0.01){
    ...
    bool DRHWInterface_SIM::robotiq_2f_close_cb(dsr_sim_msgs::Robotiq2FClose::Request& req, dsr_sim_msgs::Robotiq2FClose::Response& res)
    {
        res.success = false;
        float goal_pos = 0.0;
    ...
    bool DRHWInterface_SIM::serial_send_data_cb(dsr_sim_msgs::SerialSendData::Request& req, dsr_sim_msgs::SerialSendData::Response &res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::connect_rt_control_cb(dsr_sim_msgs::ConnectRTControl::Request& req, dsr_sim_msgs::ConnectRTControl::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::disconnect_rt_control_cb(dsr_sim_msgs::DisconnectRTControl::Request& req, dsr_sim_msgs::DisconnectRTControl::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_rt_control_output_version_list_cb(dsr_sim_msgs::GetRTControlOutputVersionList::Request& req, dsr_sim_msgs::GetRTControlOutputVersionList::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_rt_control_input_version_list_cb(dsr_sim_msgs::GetRTControlInputVersionList::Request& req, dsr_sim_msgs::GetRTControlInputVersionList::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_rt_control_input_data_list_cb(dsr_sim_msgs::GetRTControlInputDataList::Request& req, dsr_sim_msgs::GetRTControlInputDataList::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::get_rt_control_output_data_list_cb(dsr_sim_msgs::GetRTControlOutputDataList::Request& req, dsr_sim_msgs::GetRTControlOutputDataList::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_rt_control_input_cb(dsr_sim_msgs::SetRTControlInput::Request& req, dsr_sim_msgs::SetRTControlInput::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_rt_control_output_cb(dsr_sim_msgs::SetRTControlOutput::Request& req, dsr_sim_msgs::SetRTControlOutput::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::start_rt_control_cb(dsr_sim_msgs::StartRTControl::Request& req, dsr_sim_msgs::StartRTControl::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::stop_rt_control_cb(dsr_sim_msgs::StopRTControl::Request& req, dsr_sim_msgs::StopRTControl::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_velj_rt_cb(dsr_sim_msgs::SetVelJRT::Request& req, dsr_sim_msgs::SetVelJRT::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_accj_rt_cb(dsr_sim_msgs::SetAccJRT::Request& req, dsr_sim_msgs::SetAccJRT::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_velx_rt_cb(dsr_sim_msgs::SetVelXRT::Request& req, dsr_sim_msgs::SetVelXRT::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::set_accx_rt_cb(dsr_sim_msgs::SetAccXRT::Request& req, dsr_sim_msgs::SetAccXRT::Response& res)
    {
        res.success = false;
    ...
    bool DRHWInterface_SIM::read_data_rt_cb(dsr_sim_msgs::ReadDataRT::Request& req, dsr_sim_msgs::ReadDataRT::Response& res)
    {
    ...
    bool DRHWInterface_SIM::write_data_rt_cb(dsr_sim_msgs::WriteDataRT::Request& req, dsr_sim_msgs::WriteDataRT::Response& res)
    {
        res.success = false;
